lista=[{'pregunta': '¿Cuál es la moneda de México?', 'a': 'Peso', 'b': 'Dolar', 'c':'Euro' ,'correcta': 'a'}, 
       ...
       {'pregunta': '¿Qué personaje corresponde a la saga de videojuegos Mortal Kombat?', 'a': 'Chun Li', 'b': 'Kitana', 'c': 'Athena', 'correcta': 'b'},
       ...
       {'pregunta': '¿Quién es el último campeón del torneo mundial de la Fifa?', 'a': 'Argentina', 'b': 'Francia', 'c': 'Croacia', 'correcta': 'a'},
       ...
       {'pregunta': '¿Leandro va a aprobar el parcial?', 'a': 'Si', 'b': 'No', 'c':'Tal vez' ,'correcta': 'a'}
      ]
